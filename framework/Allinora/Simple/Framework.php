<?php
# Author: Atif Ghaffar
# Simple Framework built for parse.com experiment
# Derived from Allinora Frontend framework

// This the namespace under which everything should run
namespace Allinora\Simple;


// Check if this file was already loaded
if (defined('ALLINORA_SIMPLE_FRAMEWORK_LOADED')){
	die("framework was already loaded");
}

define('ALLINORA_SIMPLE_FRAMEWORK_LOADED', 1);


# Load files that are commonly needed
